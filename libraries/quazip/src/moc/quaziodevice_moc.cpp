...
static const char qt_meta_stringdata_QuaZIODevice[] = {
    "QuaZIODevice\0"
};
...
const QMetaObjectExtraData QuaZIODevice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QuaZIODevice::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QuaZIODevice,
      qt_meta_data_QuaZIODevice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QuaZIODevice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QuaZIODevice))
